...
1. **Intake** — What we consume
2. **Digestion** — How we process it
3. **Filtering and sorting** — What we keep and what we discard
4. **Integration** — How it becomes part of us
5. **Elimination** — What we release
